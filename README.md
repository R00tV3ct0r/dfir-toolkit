# 🔍 DFIR Toolkit — Ready-to-Use Toolset

An organized collection of tools for **Digital Forensics & Incident Response (DFIR)**, covering disk, memory, mobile, network and malware analysis. Designed to be **cloned and used directly** in lab, training or CTF environments.
...
```bash
git clone https://github.com/R00tV3ct0r/dfir-toolkit.git
cd dfir-toolkit
```
...
For a more complete DFIR environment, the following tools are also recommended:

* [**FTK Imager**](https://www.exterro.com/digital-forensics-software/ftk-imager) — forensic image acquisition and preview
* [**Autopsy**](https://www.autopsy.com/) — disk and filesystem forensic analysis
...
These tools are intended for **legal, educational and professional use**, including authorized digital investigations, training, CTFs and lab environments.

---

## 📄 License

Third-party tools remain subject to their respective licenses. Refer to each project's documentation for further information.
